...
function bottomNav(active) {
  ...
  return `
    ...
    <div class="fab-whatsapp" onclick="window.open('https://wa.me/2347061347599','_blank')">💬</div>`;
}
...
function renderSupport() {
  app.innerHTML = topBar("Customer Support", { noBack: true }) + `
    ...
    <div class="card" style="padding:0;">
      <div class="list-item" onclick="window.open('tel:07061347599')">
        <div><div class="l-title">📞 Phone Number</div><div class="l-sub">07061347599</div></div><div>›</div>
      </div>
      <div class="list-item" onclick="window.open('mailto:support@abbapantamidata.com')">
        <div><div class="l-title">✉️ Email</div><div class="l-sub">support@abbapantamidata.com</div></div><div>›</div>
      </div>
      <div class="list-item" onclick="window.open('https://wa.me/2347061347599')">
